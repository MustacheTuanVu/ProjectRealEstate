                    ...
                    <div class="row">
                        <div class="panel panel-default card-view">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <h3 class="txt-dark">
                                        Danh sách nhà của khách hàng:
                                    </h3>
                                    <div class="input-group">
                                        <form action="<%=request.getContextPath()%>/EstateListOfCustomer_Employee">
                                            <input type="hidden" name="user" value="employee">
                                            <input type="text" class="form-control" name="searchInput" placeholder="Nhập địa chỉ cần tìm" style="width: 500px;">
                                            <button type="submit" name="search" value="search" class="btn btn-default">Tìm kiếm</button>
                                        </form>    
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                                    ...
                                                    <div class="panel-wrapper collapse in">
                                                        <div class="panel-body row">
                                                            ...
                                                            <div class="emp-detail pl-15 pr-15">
                                                                ...
                                                                <div>
                                                                    <span class="inline-block capitalize-font mr-5">Xem chi tiết
