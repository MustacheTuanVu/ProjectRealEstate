                            ...
                            <div class="site__main">
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Add new Category</h2>
                                    </div>
                                        ...
                                        <section class="form-property form-property--dashboard">
                                            ...
                                            <div class="tab-content form-property__content">
                                                <div id="basic" role="tabpanel" class="tab-pane active">
                                                    <form action="<%=request.getContextPath()%>/CategoryCreate" method="get" class="form form--flex form--property form--basic js-form-property-1">
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Category Name</label>
                                                                <input id="in-1" required type="text" name="txtType" data-placeholder="Input Category Name" value="" class="form-control">
                                ...
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Category List</h2>
                                    </div>
                                    <div class="widget__content">
                                        <!-- BEGIN Favorites-->
                                        <section class="form-property form-property--dashboard">
                                            <div class="datatable datatable--properties">
                                                <div class="datatable__wrap">
                                                    <table class="js-properties-table datatable__table">
                                                        <thead>
                                                            <tr>
                                                                <th class="datatable__head-1">Category ID</th>
                                                                <th class="datatable__head-2 datatable__head-sort">Category Name</th>
                                                                <th class="datatable__head-3">Edit</th>
                                                                <th class="datatable__head-4">Delete</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <c:forEach items="${list}" var="item">
                                                                <tr>
                                                                    ...
                                                                    <td class="datatable__cell-5">
                                                                        <a href="<%=request.getContextPath()%>/CategoryDelete?id=${item.id}" class="form__submit">
                                                                ...
                                                                <div role="document" class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="<%=request.getContextPath()%>/CategoryEdit" method="POST" class="form form--flex form--property form--basic js-form-property-1">
                                                                                <div class="row">
                                                                                    <div class="form-group form-group--description ${hasError}">
                                                                                        ...
                                                                                        <input id="in-2" required type="text" name="txtType" data-placeholder="---" value="${item.categoryName}" class="form-control">
