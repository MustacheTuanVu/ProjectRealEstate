                                            ...
                                            <div class="datatable datatable--properties">
                                                <div class="datatable__wrap">
                                                    <table class="js-properties-table datatable__table">
                                                        <thead>
                                                            <tr>
                                                                <th class="datatable__head-1"> Estate ID</th>
                                                                <th class="datatable__head-2 datatable__head-sort"> Name Estate</th>
                                                                <th class="datatable__head-3 datatable__head-sort"> Customer Name</th>
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${list}" var="item">
                                                                <tr  data-toggle="modal" data-target="#${item.id}">
                                                                    ...
                                                                    <td class="datatable__cell-2">${item.estateName}</td>
                                                                    <td class="datatable__cell-3">${item.contractDetails.contractId.customerId.customerName}</td>
