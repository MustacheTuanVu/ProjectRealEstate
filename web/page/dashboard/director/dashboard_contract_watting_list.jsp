                            ...
                            <div class="site__main">
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Thêm tiện ích</h2>
                                    </div>
                                                    ...
                                                    <form action="<%=request.getContextPath()%>/FeatureCreate" class="form form--flex form--property form--basic js-form-property-1">
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                ...
                                                                <input id="in-1" required type="text" name="featureName" data-placeholder="Nhập tên tiện ích" value="" class="form-control">
                                ...
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Quản lý tiện ích</h2>
                                    </div>
                                    <div class="widget__content">
                                        <!-- BEGIN Favorites-->
                                        <section class="form-property form-property--dashboard">
                                            <div class="datatable datatable--properties">
                                                <div class="datatable__wrap">
                                                    <table class="js-properties-table datatable__table">
                                                        <thead>
                                                            <tr>
                                                                <th class="datatable__head-1">Tiện ích ID</th>
                                                                <th class="datatable__head-2 datatable__head-sort">Tên tiện ích</th>
                                                                <th class="datatable__head-3 datatable__head-sort">Số bất động sản</th>
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${featuresList}" var="item">
                                                                <tr>
                                                                    <td class="datatable__cell-1">${item.featuresId}</td>
                                                                    <td class="datatable__cell-2">${item.featureName}</td>
                                                                    <td class="datatable__cell-3"></td>
                                                                    <td class="datatable__cell-4">
                                                                        <button type="button" class="form__submit" data-toggle="modal" data-target="#${item.featuresId}">
                                                                            <span class="glyphicon glyphicon-edit"></span>
                                                                        </button>
                                                                    </td>
                                                                    <td class="datatable__cell-5">
                                                                        <a href="<%=request.getContextPath()%>/FeatureDelete?id=${item.featuresId}" class="form__submit">
                                                                            <span class="glyphicon glyphicon-trash"></span>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            <div id="${item.featuresId}" tabindex="-1" role="dialog" class="modal fade">
