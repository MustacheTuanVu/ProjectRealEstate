                            ...
                            <div class="site__main">
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Sửa bất động sản : ${find.id}</h2>
                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="in-5" name="direction" data-placeholder="Choose a Direction..." required class="form-control js-in-select">
                                                                    <option label=" "></option>
                                                                    <option value="East" <c:if test="${find.direction == 'East'}">selected</c:if>>East</option>
                                                                    <option value="West" <c:if test="${find.direction == 'West'}">selected</c:if>>West</option>
                                                                    <option value="South" <c:if test="${find.direction == 'South'}">selected</c:if>>South</option>
                                                                    <option value="North" <c:if test="${find.direction == 'North'}">selected</c:if>>North</option>
                                                                    <option value="South-East" <c:if test="${find.direction == 'South-East'}">selected</c:if>>South-East</option>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="in-2" class="control-label">Trạng thái</label>
                                                            ...
                                                            <div class="form-group" id="address2Form">
                                                                <label for="in-6" class="control-label">Điạ chỉ 2</label>
                                                    ...
                                                    <div id="Photo" role="tabpanel" class="tab-pane">
                                                        <div class="listing--items listing--grid listing--photos">
                                                            <div class="listing__actions">
                                                                ...
                                                                <h4 id="countimage" class="form__title js-form-title active">Bất động sản có 0/5 hình ảnh</h4>
                                                            ...
                                                            <div class="listing__list js-photos-list">
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            ...
                                                                            <img width="240" height="160" id="imageup1st" name="imageup1st" src="${find.image1st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            ...
                                                                            <img width="240" height="160" id="imageup2st" name="imageup2st" src="${find.image2st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            <input id="image3st" value="${find.image3st}" name="image3st" type="hidden"/>
                                                                            <img width="240" height="160" id="imageup3st" name="imageup3st" src="${find.image3st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            <input id="image4st" value="${find.image4st}" name="image4st" type="hidden"/>
                                                                            <img width="240" height="160" id="imageup4st" name="imageup4st" src="${find.image4st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            <input id="image5st" value="${find.image5st}" name="image5st" type="hidden"/>
                                                                            <img width="240" height="160" id="imageup5st" name="imageup5st" src="${find.image5st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group form-group--col-12 form-group--inline">
                                                                ...
                                                                <ul class="form__check">
                                                                    <c:forEach items="${featureEstateList}" var="item">
                                                                        <li>
                                                                            <input value="${item.featuresId}" type="checkbox" name="feature" id="${item.featuresId}" class="in-checkbox" checked>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h3>Bạn có muốn tiếp tục tạo bất động sản mới hay không ?</h3>
