                            ...
                            <div class="site__main">
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Quản lý bất động sản</h2>
                                    </div>
                                            ...
                                            <div class="listing--items">
                                                <div class="listing__actions">
                                                    <form action="<%=request.getContextPath()%>/EstateListOfCustomer_Employee">
                                                        ...
                                                        <input type="text" name="searchInput" placeholder="Nhập vào địa chỉ" style="width: 500px;">
                                                ...
                                                <div class="tags tags--favorites js-tags">
                                                    <div class="tags__list js-tags-list">
                                                        <a href="<%=request.getContextPath()%>/EstateListOfCustomer_Employee?user=employee" style="color: #00bbaa" class="tags__item js-tags-all">All</a>
                                                        <a href="<%=request.getContextPath()%>/EstateListOfCustomer_Employee?user=employee&filter=waitting for director" style="color: #f3bc65" class="tags__item js-tags-item">Waitting for director</a>
                                                        <a href="<%=request.getContextPath()%>/EstateListOfCustomer_Employee?user=employee&filter=waitting to transaction" style="color: #f3bc65" class="tags__item js-tags-item">Waitting to transaction</a>
                                                        <a href="<%=request.getContextPath()%>/EstateListOfCustomer_Employee?user=employee&filter=Waitting for employee" style="color: #f3bc65" class="tags__item js-tags-item">Waitting for employee</a>
                                                        <a href="<%=request.getContextPath()%>/EstateListOfCustomer_Employee?user=employee&filter=publish" style="color: #00bbaa" class="tags__item js-tags-item">Publish</a>
                                                        <a href="<%=request.getContextPath()%>/EstateListOfCustomer_Employee?user=employee&filter=project" style="color: #00bbaa" class="tags__item js-tags-item">Project</a>
                                                        <a href="<%=request.getContextPath()%>/EstateListOfCustomer_Employee?user=employee&filter=sold" style="color: #c5cbd2" class="tags__item js-tags-item">Sold</a>
                                                    </div>
                                                </div>
                                            </div>
