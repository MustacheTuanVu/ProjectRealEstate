                            ...
                            <div class="site__main">
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Quản lý bất động sản</h2><a href="<%=request.getContextPath()%>/EstateCreate" class="widget__btn js-widget-btn widget__btn--action">Add new property</a>
                                    </div>
                                                        ...
                                                        <div class="properties__item-header">
                                                            ...
                                                            <div class="properties__actions">
                                                                <c:if test="${estate.estateStatus == 'publish' || estate.estateStatus == 'waitting for employee'}">
                                                                    <a href="<%=request.getContextPath()%>/EstateEdit?estateID=${estate.id}" class="properties__link">Sửa</a>
                                                        ...
                                                        <div class="properties__thumb">
                                                            <a href="<%=request.getContextPath()%>/EstateDetails?estateID=${estate.id}" target="_blank" class="item-photo item-photo--static">
                                                                ...
                                                                <figure class="item-photo__hover item-photo__hover--params">
                                                                    ...
                                                                    <span class="properties__params">Số phòng tắm - ${estate.bathRoom} phonhg2</span>
