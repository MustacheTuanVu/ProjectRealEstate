<%-- 
    Document   : dashboard_category
    Created on : Mar 22, 2019, 8:47:38 PM
    Author     : Cuong
--%>
                            ...
                            <div class="site__main">
                                ...
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Comment manager</h2>
                                    </div>
                                            ...
                                            <div class="datatable datatable--properties">
                                                <div class="datatable__wrap">
                                                    <table class="js-properties-table datatable__table">
                                                        <thead>
                                                            <tr>
                                                                <th class="datatable__head-1 datatable__head-sort">User</th>
                                                                <th class="datatable__head-2 datatable__head-sort">Content</th>
                                                                <th class="datatable__head-3 ">Date</th>
                                                                <th class="datatable__head-4">Accept</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:forEach items="${listCommet}" var="item">
                                                                <fmt:formatDate pattern="yyyy-MM-dd" value="${item.dateComment}" var="date" />
                                                                <c:set value="${item.idUser}" var="iduser"/>
                                                                <c:if test="${iduser!=null}" >
                                                                    <tr>
                                                                        <td class="datatable__cell-1">${item.idUser.customer.customerName}</td>
                                                                        <td class="datatable__cell-2"><textarea  rows="3" cols="38" >${item.content}</textarea></td>
                                                                        <td class="datatable__cell-3">${date}</td>
                                                                        <td class="datatable__cell-4">
                                                                            <a onclick="return (confirm('Are You Sure Accept Comment  !!!'))" href="<%=request.getContextPath()%>/CommentAction?action=acceptComment&id=${item.idComment}" class="form__submit">
                                                                                <span class="glyphicon glyphicon-trash"></span>
                                                                            </a>
                                                                        </td>
                                                                        <td class="datatable__cell-5">
                                                                            <a onclick="return (confirm('Are You Sure Delete Comment !!!'))" href="<%=request.getContextPath()%>/CommentAction?action=deleteComment&id=${item.idComment}" class="form__submit">
                                                                                <span class="glyphicon glyphicon-trash"></span>
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <c:if test="${iduser==null}" >
                                                                    <tr>
                                                                        <td class="datatable__cell-1">${item.emailComment}</td>
                                                                        <td class="datatable__cell-2"><textarea  rows="3" cols="38" >${item.content}</textarea></td>
                                                                        <td class="datatable__cell-3">${date}</td>
                                                                        <td class="datatable__cell-4">
                                                                            <a onclick="return (confirm('Are You Sure Accept Comment !!!'))" href="<%=request.getContextPath()%>/CommentAction?action=acceptComment&id=${item.idComment}" class="form__submit">
                                                            ...
                                                            <c:forEach items="${listReply}" var="item">
                                                                <fmt:formatDate pattern="yyyy-MM-dd" value="${item.dateReply}" var="date" />
                                                                <c:set value="${item.idUser}" var="iduser"/>
                                                                <c:if test="${iduser!=null}" >
                                                                    <tr>
                                                                        <td class="datatable__cell-1">${item.idUser.customer.customerName}</td>
                                                                        ...
                                                                        <td class="datatable__cell-3">${date}</td>
                                                                        <td class="datatable__cell-4">
                                                                            <a onclick="return (confirm('Are You Sure Accept Reply !!!'))" href="<%=request.getContextPath()%>/CommentAction?action=acceptReply&id=${item.idReply}" class="form__submit">
                                                                                <span class="glyphicon glyphicon-trash"></span>
                                                                            </a>
                                                                        </td>
                                                                        <td class="datatable__cell-5">
                                                                            <a onclick="return (confirm('Are You Sure Delete Reply !!!'))" href="<%=request.getContextPath()%>/CommentAction?action=deleteReply&id=${item.idReply}" class="form__submit">
                                                                                <span class="glyphicon glyphicon-trash"></span>
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <c:if test="${iduser==null}" >
                                                                    <tr>
                                                                        <td class="datatable__cell-1">${item.emailReply}</td>
                                                                        <td class="datatable__cell-2"><textarea  rows="3" cols="38" >${item.content}</textarea></td>
                                                                        <td class="datatable__cell-3">${date}</td>
                                                                        <td class="datatable__cell-4">
                                                                            <a onclick="return (confirm('Are You Sure Accept Reply !!!'))" href="<%=request.getContextPath()%>/CommentAction?action=acceptReply&id=${item.idReply}" class="form__submit">
                                                                    ...
                                                                    <form action="<%=request.getContextPath()%>/CategoryEdit" class="form form--flex form--property form--basic js-form-property-1">
                                                                        <div class="row">
                                                                            <div class="form-group form-group--description ${hasErrorEdit}">
                                                                                <label for="in-1" class="control-label">Category ID</label>
                                                                                <input id="in-1" required type="text" name="featureID" value="${id}" class="form-control" readonly="true">
                                                                                <label for="in-2" class="control-label">Category Name</label>
            ...
            <div id="myModalDelete" tabindex="-1" role="dialog" class="modal fade">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h3>This type can't delete because it have blog ?</h3>
