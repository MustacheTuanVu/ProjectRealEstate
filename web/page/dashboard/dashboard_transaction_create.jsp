                            ...
                            <div class="site__main">
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Add New TRansaction</h2>
                                        ...
                                        <section class="form-property form-property--dashboard">
                                            ...
                                            <div class="tab-content form-property__content">
                                                <div id="basic" role="tabpanel" class="tab-pane active">
                                                    <form action="<%=request.getContextPath()%>/TransactionCreate" method="POST" class="form form--flex form--property form--basic js-form-property-1">
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                ...
                                                                <select name="cus" id="in-2">
                                                                    <c:forEach items="${listCus}" var="cus" >
                                                                        <option class="form-control">${cus.customerName}</option> 
                                                                    </c:forEach>
                                                                </select>

                                                                <label for="in-8" class="control-label">Number Contract</label>
                                                                <select name="con" id="in-8">
                                                                    <c:forEach items="${listCon}" var="con" >
                                                                        <option class="form-control">${con.id}</option> 
                                                                    </c:forEach>
                                                                </select>

                                                                <label for="in-4" class="control-label">Payment Amount</label>
                                                                <input id="in-4"  type="text" name="currency-field" id="currency-field" class="form-control" 
                                                                       pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$"
                                                                       data-type="currency" placeholder="$1,000,000">
                                                                ...
                                                                <textarea  id="in-10" type="text" name="txtDetails"  class="form-control" ></textarea>
