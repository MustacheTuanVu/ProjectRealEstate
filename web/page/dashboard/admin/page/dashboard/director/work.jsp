                                    ...
                                    <div class="table-wrap">
                                        <div class="table-responsive">
                                            <table id="footable_1" class="table" data-sorting="true">
                                                <thead>
                                                    <tr>
                                                        <th data-name="id" data-breakpoints="xs" data-type="number">Khách hàng</th>
                                                        <th data-name="firstName">Nhân viên</th>
                                                        <th data-name="lastName">Địa chỉ</th>
                                                        <th data-name="jobTitle" data-breakpoints="xs">Giá mong muốn</th>
                                                        <th data-name="startedOn" data-breakpoints="xs sm">Tình trạng</th>
                                                    </tr>
                                                </thead>
                                                <c:forEach items="${contractList}" var="item">
                                                    <tr>
                                                        <td data-title="ID" data-breakpoints="xs">${item.contractId.customerId.customerName}</td>
                                                        <td>${item.contractId.employeeId.employeeName}</td>
                                                        <td>${item.estateId.address1} - ${item.estateId.address2}</td>
                                                        <td data-title="Job Title" data-breakpoints="xs">${item.estateId.price}</td>
