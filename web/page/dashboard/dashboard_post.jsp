                            ...
                            <div class="site__main">
                                ...
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        ...
                                        <h2 class="widget__title">Post manager</h2>
                                    </div>
                                    <div class="widget__content">
                                        <!-- BEGIN Favorites-->
                                                    ...
                                                    <table class="js-properties-table datatable__table">
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${listPost}" var="item">
                                                                <tr data-toggle="modal" data-target="#${item.postId}">

                                                                    <td class="datatable__cell-1">${item.postTilte}</td>
                                                                    <td class="datatable__cell-2">${item.postCategory.categoryName}</td>
                                                                    <td class="datatable__cell-3">${item.employee.employeeName}</td>

                                                                    <td class="datatable__cell-5">
                                                                        <a href="<%=request.getContextPath()%>/PaymentDelete?id=${item.postId}" class="form__submit">
                                                                            <span class="glyphicon glyphicon-trash"></span>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            <div id="${item.postId}" tabindex="-1" role="dialog" class="modal fade">
