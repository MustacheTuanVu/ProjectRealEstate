                            ...
                            <div class="site__main">
                                ...
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">ContractList Manager</h2>
                                    </div>
                                            ...
                                            <div class="datatable datatable--properties">
                                                <div class="datatable__wrap">
                                                    <table class="js-properties-table datatable__table">
                                                        <thead>
                                                            <tr>
                                                                <th class="datatable__head-1">Number Contract</th>
                                                                <th class="datatable__head-2 datatable__head-sort">Customer Name</th>
                                                                <th class="datatable__head-3 datatable__head-sort">Employee Name</th>

                                                                <th class="datatable__head-6">Estate Name</th>
                                                                <th class="datatable__head-7">Delete</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <c:forEach items="${list}" var="item">
                                                                <tr data-toggle="modal" data-target="#${item.id}">
                                                                    ...
                                                                    <td class="datatable__cell-2">${item.customerId.customerName}</td>
                                                                    <td class="datatable__cell-3">${item.employeeId.employeeName}</td>
                                                                    <td class="datatable__cell-6"> 
                                                                        ${item.contractDetails1.estateId.estateName}
                                                                    </td>
                                                                    <td class="datatable__cell-7">
                                                                                    ...
                                                                                    <div class="form-group form-group--description ${hasError}">
                                                                                        ...
                                                                                        <select name="cus" id="in-2">
                                                                                            <c:forEach items="${listCus}" var="cus" >
                                                                                                <option value="${cus.id}" ${cus.id==item.customerId.id ? 'selected' : ''} class="form-control">${cus.customerName}</option> 
                                                                                            </c:forEach>
                                                                                        </select>
                                                                                        <label for="in-3" class="control-label">Employee Name</label>
                                                                                        <select name="emp" id="in-3">
                                                                                            <c:forEach items="${listEmp}" var="emp" >
                                                                                                <option value="${emp.id}" ${emp.id==item.employeeId.id ? 'selected' : ''} class="form-control">${emp.employeeName}</option>   
                                                                                            </c:forEach>
                                                                                        </select>
                                                                                        <label for="in-9" class="control-label">Contract Type</label>
                                                                                        <select name="type" id="in-9">
                                                                                            <c:forEach items="${listType}" var="type" >
                                                                                                <option value="${type.id}" ${type.id==item.contractTypeId.id ? 'selected' : ''} class="form-control">${type.contractTypeName}</option> 
                                                                                            </c:forEach>
                                                                                        </select>
                                                                                        <label for="in-8" class="control-label">Payment Type</label>
                                                                                        <select name="pay" id="in-8">
                                                                                            <c:forEach items="${listPay}" var="pay" >
                                                                                                <option value="${pay.id}" ${pay.id==item.paymentFrequency.id ? 'selected' : ''} class="form-control">${pay.paymentFrequencyName}</option> 
                                                                                            </c:forEach>
                                                                                        </select>
                                                                                        ...
                                                                                        <input id="in-4"  type="text" name="currency-field" id="currency-field" class="form-control" 
                                                                                               pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" value="${item.paymentAmount}" 
                                                                                               data-type="currency" placeholder="$1,000,000.00">


                                                                                        <label for="in-5" class="control-label">Fee Precentage</label>
                                                                                        <input id="in-5" required type="number" name="txtFee" value="${item.feePrecentage}" class="form-control" >
                                                                                        <label for="in-6" class="control-label">Date Sign</label>
                                                                                        <fmt:formatDate pattern="yyyy-MM-dd" value="${item.dateSigned}" type="date" var="date" />
                                                                                        <input id="in-6" required type="date" name="txtdate" value="${date}" class="form-control" />
                                                                                        <label for="in-7" class="control-label">Document URL</label>
                                                                                        <input id="in-7" required type="text" name="txtID" value="${item.documentUrl}" class="form-control" >
                                                                                        <label for="in-10" class="control-label">Details</label>
                                                                                        <textarea  id="in-10" required type="text" name="txtDetails"  class="form-control" >${item.contractDetails}
                                                                                        </textarea>
                                                                    ...
                                                                    <form action="<%=request.getContextPath()%>/Edit_Customer_Servlet" method="POST" class="form form--flex form--property form--basic js-form-property-1">
                                                                        <div class="row">
                                                                            <div class="form-group form-group--description ${hasErrorEdit}">
                                                                                ...
                                                                                <input id="in-2" required type="text" name="txtPay" data-placeholder="---" value="${username}" class="form-control">
