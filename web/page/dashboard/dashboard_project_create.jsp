                            ...
                            <div class="site__main">
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Add new project</h2>
                                    </div>
                                        ...
                                        <section class="form-property form-property--dashboard">
                                            ...
                                            <div class="tab-content form-property__content">
                                                <div id="basic" role="tabpanel" class="tab-pane active">
                                                    <form action="<%=request.getContextPath()%>/ProjectCreate" class="form form--flex form--property form--basic js-form-property-1" method="POST">
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Project Id</label>
                                                                <input id="in-1" type="text" name="projectId" data-placeholder="Input Project Id" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                ...
                                                                <input id="in-1" type="text" name="projectName" data-placeholder="Input Project Name" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Project Address</label>
                                                                <input id="in-1" type="text" name="projectAddress" data-placeholder="Input Project Address" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Project Status</label>
                                                                <input id="in-1" type="text" required name="projectStatus" data-placeholder="Input Project Status" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Project Number</label>
                                                                <input id="in-1" type="text" name="projectBlockNumber" data-placeholder="Input Project Block Number" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Project Are</label>
                                                                <input id="in-1" type="text" name="projectAre" data-placeholder="Input Project Are" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Manager Id</label>
                                                                <input id="in-1" type="text" name="managerId" data-placeholder="Input Manager Id" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Image 1st</label>
                                                                <input id="in-1" type="text" name="image1st" data-placeholder="Input Image1st" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Image 2st</label>
                                                                <input id="in-1" type="text" name="image2st" data-placeholder="Input Image2st" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Image 3st</label>
                                                                <input id="in-1" type="text" name="image3st" data-placeholder="Input Image3st" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Image 4st</label>
                                                                <input id="in-1" type="text" name="image4st" data-placeholder="Input Image4st" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Image 5st</label>
                                                                <input id="in-1" type="text" name="image5st" data-placeholder="Input Image5st" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Document Url</label>
                                                                <input id="in-1" type="text" name="documentUrl" data-placeholder="Input Document Url" value="" class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Project Status</label>
                                                                <input id="in-1" type="text" name="projectStatus" data-placeholder="Input Project Status" value="" class="form-control">
