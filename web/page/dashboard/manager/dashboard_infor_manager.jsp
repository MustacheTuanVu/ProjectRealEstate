                                            ...
                                            <div id="form-block-1" class="form__block js-form-block">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="in-1" value="${customer.managerId}" readonly name="txtID" data-placeholder="---" value="Lara Group Agency" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="in-2" class="control-label">Your Name</label>
                                                        <input id="in-2" readonly value="${customer.managerName}" required name="txtName" data-placeholder="---" value="Lara Group Agency" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="in-3" class="control-label">Identity Card</label>
                                                        <input id="in-3" readonly value="${customer.managerIndentityCard}" required name="txtCard" data-placeholder="---" value="Lara Group Agency" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="in-4" class="control-label">Address</label>
                                                        <input id="in-4" readonly value="${customer.managerAddress}" required name="txtAddress" data-placeholder="---" value="Lara Group Agency" class="form-control">
                                            ...
                                            <div id="form-block-2" class="form__block js-form-block">
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="in-11" readonly name="txtPhone" value="${customer.managerPhone}" type="text" required value="adam.svenson@realtyspace.com" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="in-12" class="control-label">Email</label>
                                                        <input id="in-12" readonly name="txtMail" value="${customer.managerMail}" type="email" placeholder="" required value="adam.svenson@realtyspace.com" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <header class="form__header">
