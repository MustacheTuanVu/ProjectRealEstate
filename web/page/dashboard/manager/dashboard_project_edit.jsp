                                ...
                                <div class="widget js-widget widget--dashboard">
                                    ...
                                    <div class="widget__content">
                                        ...
                                        <section class="form-property form-property--dashboard">
                                            ...
                                            <!-- Tab panes-->
                                            <form action="<%=request.getContextPath()%>/ProjectEdit" method="POST" class="form form--flex form--property form--basic js-form-property-1">
                                                    ...
                                                    <div id="basic" role="tabpanel" class="tab-pane active">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group form-group--description ${hasError}">
                                                                ...
                                                                <input id="in-1" required type="text" name="projectName" value="${project.projectName}" class="form-control">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="in-10" type="number" name="blockNumber" value="${project.blockNumber}" class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="in-10" class="control-label">Floor Number</label>
                                                                <input id="in-10" type="number" name="floorNumber" value="${project.floorNumber}" class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input id="in-6" type="text" name="address" value="${project.projectAddress}" required class="form-control">
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <select id="in-5" name="district" re data-placeholder="Choose a District..." required class="form-control js-in-select">
                                                                    <c:if test="${project.district != null}">
                                                                        <option value="${project.district}" selected>${project.district}</option>
                                                                    </c:if>
                                                                    <c:if test="${project.district == null}">
                                                        ...
                                                        <div class="listing--items listing--grid listing--photos">
                                                            ...
                                                            <div class="listing__list js-photos-list">
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            <input value="${project.image1st}" id="image1st" name="image1st" type="hidden"/>
                                                                            <img width="240" height="160" id="imageup1st" name="imageup1st" src="${project.image1st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            <input value="${project.image2st}" id="image2st" name="image2st" type="hidden"/>
                                                                            <img width="240" height="160" id="imageup2st" name="imageup2st" src="${project.image2st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            ...
                                                                            <img width="240" height="160" id="imageup3st" name="imageup3st" src="${project.image3st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            ...
                                                                            <img width="240" height="160" id="imageup4st" name="imageup4st" src="${project.image4st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="listing__item js-listing-item">
                                                                    ...
                                                                    <div class="listing__thumb">
                                                                        <a class="item-photo item-photo--static js-gallery-item">
                                                                            ...
                                                                            <img width="240" height="160" id="imageup5st" name="imageup5st" src="${project.image5st}" alt="">
                                                                        </a>
                                                                    </div>
                                                                </div>
