                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control--select">
                                                <select id="in-listing-sort" onchange="changeFunc()" class="form-control js-in-select">
                                                    ...
                                                    <option value="date_add desc">Thời gian giảm dần</option>
                                    ...
                                    <div class="widget js-widget widget--main">
                                        <div class="widget__content">
                                            ...
                                            <div class="listing listing--grid js-properties-list">
                                                <c:forEach items="${contractDetailsList}" var="item">
                                                    <div class="listing__item">
                                                        <div class="properties__item-header">
                                                            <c:choose>
                                                                ...
                                                                <c:when test="${item.contractId.contractDetails == 'my request sale' && item.contractId.status == 'done'}">
                                                                    <span class="properties__state properties__state--hidden">Bán/thuê thành công</span>
                                                                </c:when>
                                                        ...
                                                        <div class="properties properties--grid">
                                                            <div class="properties__thumb">
                                                                ...
                                                                <span class="properties__ribon">${item.estateId.estateStatusId.estateStatusName}</span>
                                                                <span class="properties__ribon properties__ribon--status properties__ribon--done">${item.estateId.estateTypeId.typeName}</span>
                                                            </div>
                                                            ...
                                                            <div class="properties__details">
                                                                <div class="properties__info">
                                                                    <a 
                                                                        ...
                                                                        <span class="properties__address-street">${item.estateId.estateName}</span>
                                                                        <span class="properties__address-city">${item.estateId.address2}</span>
                                                                    </a>
