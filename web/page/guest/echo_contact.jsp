                        ...
                        <div class="site site--main">
                            ...
                            <div class="site__main">
                                <div class="widget js-widget widget--main">
                                                ...
                                                <div class="info__table-wrap">
                                                    <table class="table info__table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td></td>
                                                                <td><img src="${estate.image2st}" alt="image" width="270" height="175"></td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td><img src="${estate.image3st}" alt="image" width="270" height="175"></td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td><img src="${estate.image4st}" alt="image" width="270" height="175"></td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                                                <td></td>
                                                                <td><img src="${estate.image5st}" alt="image" width="270" height="175"></td>
                                                                <td></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <div class="widget__content" id="section-2" style="display: none;">
                                        <section class="info info--statistics">
                                            <div class="info__about">
                                                ...
                                                <div id="section-to-print" class="maincontent textview">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td valign="top" width="374">
                                                                    <p align="center"><strong>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</strong><br><strong>Độc lập - Tự do - Hạnh phúc<br></strong><strong>---------------------</strong></p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td valign="top" width="277">
                                                                    <p align="center">Số:...../HDQC</p>
                                                                </td>
                                                                <td valign="top" width="374">
                                                                    <p style="text-align: right;" align="center"><em>.........., ngày...tháng...năm...</em></p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <h3 align="center"><strong>HỢP ĐỒNG MUA BÁN BẤT ĐỘNG SẢN</strong></h3>
                                                    <p>- Căn cứ <a href="https://vndoc.com/bo-luat-dan-su-so-91-2015-qh13/download">Bộ luật dân sự Nước Cộng hòa xã hội chủ nghĩa Việt Nam 2015</a>.</p>
                                                    <p>- Căn cứ <a href="https://vndoc.com/luat-kinh-doanh-bat-dong-san-so-66-2014-qh13/download">Luật kinh doanh bất động sản 2014</a>.</p>
                                                    <p>- Căn cứ <a href="https://vndoc.com/luat-dat-dai-so-45-2013-qh13/download">Luật đất đai số 45/2013/QH13</a>.</p>
                                                    <p>- Căn cứ <a href="https://vndoc.com/luat-so-36-2005-qh11/download">Luật số 36/2005/SH11</a> ngày 14 tháng 6 năm 2005 về thương mại.</p>
                                                    ...
                                                    <p style="text-align: justify;">Số CMND: ${customer.customerIndentityCard}</p>
                                                    <p style="text-align: justify;">Hai bên đồng ý ký kết hợp đồng mua bán bất động sản với các điều khoản sau:</p>
                                                    <p style="text-align: justify;"><strong>Điều 1: Nội dung thỏa thuận</strong></p>
                                                    <p style="text-align: justify;">Bên A bằng văn bản này cùng với những cam kết sau đây bán cho bên B Bất động sản có địa chỉ như trên và đồng ý nhượng quyền sử dụng đất có nhà ở nằm trong khuôn viên được xác định bởi các giấy tờ đã nêu trên.</p>
                                                    <p style="text-align: justify;">Đặc điểm của Bất động sản:</p>
                                                    <p style="text-align: justify;">- Vị trí: ${estate.address1} - ${estate.address2}</p>
                                                    <p style="text-align: justify;">- Diện tích: ${estate.areas}m2</p>
                                                    ...
                                                    <p style="text-align: justify;"><strong>Điều 2: Trách nhiệm của các bên</strong></p>
                                                    <p style="text-align: justify;">Các thành viên bên B liên đới cùng chịu trách nhiệm về quyền lợi và nghĩa vụ của mình khi được mua. Bên B chấp nhận mọi quy định về địa dịch thông hành đã có và sẽ có, các quy định về lộ giới, quy hoạch xây dựng, chỉnh trạng đô thị, quy hoạch sử dụng đất vì lợi ích quốc gia cùng toàn bộ những rủi ro hoặc thiệt hại sẽ xảy ra, trừ những điều pháp luật cấm mua bán chuyển dịch mà bên A cố tình giấu diếm bên B.</p>
                                                    <p style="text-align: justify;">Bên B sẽ đóng đủ mọi thứ thuế theo quy định đối với Bất động sản đã mua bán chuyển nhượng bởi hợp đồng này kể từ ngày thực sự làm chủ sở hữu theo quy định khác nếu có.</p>
                                                    <p style="text-align: justify;"><strong>Điều 3: Phương thức thanh toán, thời gian và địa điểm thanh toán tiền mua bán bất động sản, thời gian giao nhận bất động sản</strong></p>
                                                    <p style="text-align: justify;">Phương thức thanh toán, thời gian và địa điểm giao nhận tiền:</p>
                                                    <p style="text-align: justify;">-&nbsp;Đợt 1:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                                    <p style="text-align: justify;">-&nbsp;Đợt 2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                                    <p style="text-align: justify;">Bên A đã nhận đủ số tiền ................................................................................ do bên B giao.</p>
                                                    <p style="text-align: justify;">Thời gian và điều kiện giao nhận Bất động sản:</p>
                                                    <p style="text-align: justify;">-&nbsp;Thời gian giao bất động sản:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                                    <p style="text-align: justify;">-&nbsp;Điều kiện giao bất động sản:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                                    <p style="text-align: justify;">Bên A phải có trách nhiệm di chuyển người và đồ vật ra khỏi nhà trước khi giao</p>
                                                    <p style="text-align: justify;">nhà cho bên B, bên A phải giao đầy đủ nhà cùng với các tiện nghi như đồng hồ điện nước, các công trình phụ sẵn có.</p>
                                                    <p style="text-align: justify;">Bên A đảm bảo cho bên B về mặt pháp lý và trên thực tế được hưởng quyền sở hữu thực sự.</p>
                                                    <p style="text-align: justify;"><strong>Điều 4: Quyền và nghĩa vụ của&nbsp;Bên A</strong></p>
                                                    <p style="text-align: justify;">Bên A giao nhà đúng tình trạng hiện hữu và đúng thời hạn đã quy định trong hợp đồng, đồng thời giao đủ toàn bộ hồ sơ có liên quan đến Bất động sản nói trên cho bên B, cùng với các điều kiện đã nêu ở Điều 3.</p>
                                                    <p style="text-align: justify;">Nhận tiền của bên B theo phương thức đã thỏa thuận trong hợp đồng này.</p>
                                                    <p style="text-align: justify;">Phải bảo quản Bất động sản đã chuyển nhượng trong thời gian chưa giao giao cho bên B, không được thế chấp, cho thuê hoặc hứa bán cho người khác.</p>
                                                    <p style="text-align: justify;">Có nghĩa vụ đóng góp các loại thuế theo quy định để tạo điều kiện thuận lợi cho bên B tiến hành đăng ký trước bạ sang bên cơ quan có thẩm quyền.</p>
                                                    <p style="text-align: justify;"><strong>Điều 5: Quyền và nghĩa vụ của Bên B</strong></p>
                                                    <p style="text-align: justify;">Được nhận bất động sản theo tình trạng đã quy định trong hợp đồng và được nhận toàn bộ hồ sơ về Bất động sản.</p>
                                                    <p style="text-align: justify;">Trả đủ tiền chuyển nhượng cho bên A theo thỏa thuận đã ghi trong hợp đồng.</p>
                                                    <p style="text-align: justify;">Đóng thuế trước bạ đầy đủ và đăng bộ theo quy định.</p>
                                                    <p style="text-align: justify;"><strong>Điều 6: Cam kết của các bên</strong></p>
                                                    <p style="text-align: justify;">Cam kết của bên A</p>
                                                    <p style="text-align: justify;">- Bên A cam kết về tình trạng sở hữu của bất động sản: Bất động sản nêu trong hợp đồng này là thuộc quyền sở hữu hợp pháp của bên A, không phải do bên A đứng tên thay người khác.</p>
                                                    <p style="text-align: justify;">- Bất động sản bên A chuyển nhượng không thuộc diện xử lý theo các chính sách cải tạo của Nhà nước.</p>
                                                    <p style="text-align: justify;">- Nhà và đất trong khuôn viên không bị tranh chấp về quyền sở hữu và quyền sử dụng.</p>
                                                    <p style="text-align: justify;">- Bất động sản không bị xử lý bằng các quyết định của cơ quan Nhà nước có thẩm quyền mà chủ sở hữu chưa chấp hành.</p>
                                                    <p style="text-align: justify;">- Bất động sản không bị buộc phải bỏ dở theo quyết định của cơ quan có thẩm quyền.</p>
                                                    <p style="text-align: justify;">- Trong trường hợp bên A đem bán bất động sản mà đang bị vướng một trong những điều đã cam kết trên đây do đó đã gây thiệt hại cho bên B, bên A cam kết sẽ hoàn trả đủ ngay lập tức tiền bán cho bên B và sẽ bồi thường cho bên B theo thỏa thuận của hai bên. Trong trường hợp hai bên không thỏa thuận được thì bên B có quyền khởi kiện ra Tòa án và bên A phải bồi thường cho bên B theo phán quyết của Tòa án.</p>
                                                    <p style="text-align: justify;">Cam kết của bên B</p>
                                                    <p style="text-align: justify;">- Đã xem xét rõ tình trạng hiện hữu của Bất động sản bao gồm cả giấy tờ chủ quyền bất động sản và bằng lòng nhận, đồng thời cam kết không khiếu nại gì.</p>
                                                    <p style="text-align: justify;">- Tôn trọng mọi địa dịch thông hành cũ và mới theo quy định của pháp luật(nếu có).</p>
                                                    <p style="text-align: justify;"><strong>Điều 7: Điều khoản chung</strong></p>
                                                    <p style="text-align: justify;">- Hai bên cam kết thực hiện đầy đủ các điều khoản đã ghi trong hợp đồng, trường hợp phát sinh tranh chấp, hai bên cùng nhau thương lượng giải quyết, nếu hai bên không tự giải quyết được thì được quyền đưa đến cơ quan Tòa án để yêu cầu giải quyết theo quy định của pháp luật.</p>
                                                    <p style="text-align: justify;">- Mọi sửa đổi, bổ sung hợp đồng này chỉ có giá trị khi được lập bằng văn bản và do hai bên ký tên.</p>
                                                    <p style="text-align: justify;">- Hợp đồng được lập thành 02 bản, mỗi bên giữ một bản có giá trị pháp lý như nhau.</p>
                                                    <table style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                            <tr>
                                                                <td width="319">
                                                                    <p align="center"><strong>BÊN A</strong></p>
                                                                    <p align="center"><em>(Ký và ghi rõ họ tên)</em></p>
                                                                </td>
                                                                <td width="319">
                                                                    <p align="center"><strong>BÊN B</strong></p>
                                                                    <p align="center"><em>(Ký và ghi rõ họ tên)</em></p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
