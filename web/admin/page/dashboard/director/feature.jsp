                                        ...
                                        <div class="table-responsive">
                                            <table id="datable_1" class="table table-hover display  pb-30">
                                                ...
                                                <c:forEach items="${featuresList}" var="item">
                                                    <tr>
                                                    <tr>
                                                        <td>${item.featuresId}</td>
                                                        <td>${item.featureName}</td>
                                                        <td>
                                                            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#${item.featuresId}">
                                                                <span class="glyphicon glyphicon-edit"></span>
                                                            </button>
                                                        </td>
                                                        <td class="datatable__cell-5">
                                                            <a href="<%=request.getContextPath()%>/FeatureDelete?id=${item.featuresId}" class="btn btn-default">
