                                            ...
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                <div class="panel 
                                                     <c:choose>
                                                         ...
                                                         <c:when test="${item.projectStatus == 'waitting for director' ||
                                                                         item.projectStatus == 'waitting for director create' ||
                                                                         item.projectStatus == 'waitting for director edit'||
                                                                         item.projectStatus == 'waitting for director delete'
                                                                 }">
                                                             panel-warning
                                                         </c:when>
                                                         ...
                                                         <c:when test="${item.projectStatus == 'publish'}">
                                                             panel-success
                                                         </c:when>
                                                    ...
                                                    <div class="panel-heading">
                                                        ...
                                                        <div class="pull-right">
                                                            <c:if test="${item.projectStatus == 'waitting for director create' || item.projectStatus == 'waitting for director edit'}">
                                                                <a class="pull-left inline-block mr-15" href="<%=request.getContextPath()%>/ProjectArgree?projectID=${item.projectId}&choice=add">
                                                                    <i class="glyphicon glyphicon-ok txt-light"></i>
                                                                </a>
                                                                <a class="pull-left inline-block mr-15" href="<%=request.getContextPath()%>/ProjectArgree?projectID=${item.projectId}&choice=remove">
                                                                    <i class="glyphicon glyphicon-remove txt-light"></i>
                                                                </a>
                                                            </c:if>
                                                            <c:if test="${item.projectStatus == 'waitting for director delete'}">
                                                                <a class="pull-left inline-block mr-15" href="<%=request.getContextPath()%>/ProjectArgree?projectID=${item.projectId}&choice=add">
                                                                    <i class="glyphicon glyphicon-ok txt-light"></i>
                                                                </a>
                                                            </c:if>
                                                            <a class="pull-left inline-block mr-15" href="<%=request.getContextPath()%>/ProjectDetails?projectId=${item.projectId}" target="_blank">
                                                    ...
                                                    <div class="panel-wrapper collapse in">
                                                        <div class="panel-body row">
                                                            <div class="pull-right mr-15" >
                                                                <img src="${item.image1st}" alt="estateImage" width="150px" height="150px">
                                                            </div>
                                                            <div class="user-others-details pl-15 pr-15">
                                                                <div class="mb-15">
                                                                    <span class="inline-block capitalize-font mr-5">Số tầng:</span>
                                                                    <span class="txt-dark">${item.floorNumber}</span>
                                                                </div>
                                                                <div class="mb-15">
                                                                    <span class="inline-block capitalize-font mr-5">Số block:</span>
                                                                    <span class="txt-dark">${item.blockNumber}</span>
                                                                </div>
                                                                <div class="mb-15">
                                                                    <span class="inline-block capitalize-font mr-5">Năm hoàn thành:</span>
                                                                    <span class="txt-dark"><fmt:formatDate value="${item.yearBuild}" pattern="yyyy" /></span>
                                                                </div>
                                                                <div class="mb-15">
                                                                    <span class="inline-block capitalize-font mr-5">Thời gian mở:</span>
                                                                    <span class="txt-dark"><fmt:formatDate value="${item.dateAdd}" pattern="dd/MM/yyyy" /></span>
                                                                </div>
                                                                <div class="mb-15">
                                                                    <span class="inline-block capitalize-font mr-5">Khu vực:</span>
                                                                    <span class="txt-dark">Quận ${item.district}</span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="emp-detail pl-15 pr-15">
                                                                <div class="mb-5">
                                                                    ...
                                                                    <span class="txt-dark">${item.projectAddress}</span>
                                                                </div>
                                                                <div>
                                                                    <span class="inline-block capitalize-font mr-5">Nhân viên phụ trách:</span>
                                                                    <span class="txt-dark">${item.managerId.managerName}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
