                                            ...
                                            <div id="example-basic">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div id="estateNameForm" class="form-group">
                                                                ...
                                                                <input onchange="checkStep1()" type="text" id="estateName" class="form-control" name="estateName">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <div id="garagesForm" class="form-group">
                                                                    ...
                                                                    <input onchange="checkStep1()" type="number" id="garages" class="form-control" name="garages">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div id="areasForm" class="form-group">
                                                                ...
                                                                <input onchange="checkStep1()" type="number" id="areas" class="form-control" name="areas">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div id="addressForm" class="form-group">
                                                                ...
                                                                <input onchange="checkStep1()" type="text" id="address" class="form-control" name="address2">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div id="yearBuildForm" class="form-group">
                                                                ...
                                                                <input onchange="checkStep1()" id="yearBuild" name="yearBuild" type="text" placeholder="" data-mask="9999" class="form-control">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div id="estateDescriptionForm" class="form-group">
                                                                ...
                                                                <textarea onchange="checkStep1()" id="estateDescription" class="form-control" rows="5" name="estateDescription"></textarea>
                                                ...
                                                <section>
                                                    ...
                                                    <div class="row">
                                                        <c:forEach items="${employeeList}" var="employee">
                                                            <c:if test="${employee.employeeMail != 'wait'}">
                                                                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                                    <div id="panelEmployee${employee.id}" style="display: block" class="panel panel-success contact-card card-view">
                                                                        <div class="panel-heading">
                                                                            <div class="pull-left">
                                                                            ...
                                                                            <div class="pull-right">
                                                                                <a class="pull-left inline-block mr-15" onclick="getEmployeeID(${employee.id})">
                                                                                    <i id="tickEmployee${employee.id}" class="glyphicon glyphicon-ok txt-light"></i>
                                                                                </a>
                                                        ...
                                                        <input type="hidden" id="employeeIDGet" name="employeeID" value="0">
                                                    </div>
                                                    <!-- Row -->
