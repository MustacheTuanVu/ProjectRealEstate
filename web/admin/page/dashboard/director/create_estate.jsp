                                        ...
                                        <form method="POST" action="<%=request.getContextPath()%>/EstateCreate" class="form form--flex form--property form--basic js-form-property-1">
                                            <div id="example-basic">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="estateName" class="form-control" placeholder="" data-mask="999 m2" name="garages">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                ...
                                                <section>
                                                    ...
                                                    <!-- Row -->
                                                    <button class="btn btn-success btn-anim" type="submit"><i class="icon-rocket"></i><span class="btn-text">Đăng lên</span></button>
                                                </section>
                                            </div>
                                        </form>
                                    </div>
