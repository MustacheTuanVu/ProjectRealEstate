                                        ...
                                        <div class="col-md-12">
                                            <form action="<%=request.getContextPath()%>/CategoryCreate" class="form form--flex form--property form--basic js-form-property-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="featureName" class="form-control" placeholder="Tên danh mục">
                                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datable_1" class="table table-hover display  pb-30">
                                                ...
                                                <c:forEach items="${featuresList}" var="item">
                                                    <tr>
                                                        <td class="datatable__cell-1">${item.categoryId}</td>
                                                        <td class="datatable__cell-2">${item.categoryName}</td>
                                                        <td class="datatable__cell-4">
                                                            <button type="button" class="form__submit" data-toggle="modal" data-target="#${item.categoryId}">
                                                                <span class="glyphicon glyphicon-edit"></span>
                                                            </button>
                                                        </td>
                                                        <td class="datatable__cell-5">
                                                            <a onclick="return (confirm('Are You Sure !!!'))" href="<%=request.getContextPath()%>/CategoryDelete?id=${item.categoryId}" class="form__submit">
                                                                <span class="glyphicon glyphicon-trash"></span>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <div id="${item.categoryId}" tabindex="-1" role="dialog" class="modal">
