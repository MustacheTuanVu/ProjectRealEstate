                        ...
                        <div class="panel panel-default card-view">
                            ...
                            <div  class="panel-wrapper collapse in">
                                <div  class="panel-body">
                                    <div class="row">
                                        <a href="<%=request.getContextPath()%>/ContractOfEmployee?action=khaosat" >
                                        ...
                                        <a href="<%=request.getContextPath()%>/ContractOfEmployee?action=choban" >
                                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                <div class="panel panel-default card-view pa-0">
                                                    <div class="panel-wrapper collapse in">
                                                        <div class="panel-body pa-0">
                                                            <div class="sm-data-box bg-yellow">
                                                                <div class="container-fluid">
                                                                    <div class="row">
                                                                        <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                                            <span class="txt-light block counter"><span class="counter-anim">${countEstateSale}</span></span>
                                                                            <span class="weight-500 uppercase-font txt-light block">Chờ Bán</span>
                                                                        </div>
                                                                        <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="row">
                                                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                                        ...
                                                                        <span class="weight-500 uppercase-font txt-light block">Giao Dịch Thành Công</span>
                                                                    </div>
                                                                    <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                        ...
                                        <a href="<%=request.getContextPath()%>/ContractOfEmployee" >
                                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                <div class="panel panel-default card-view pa-0">
                                                    <div class="panel-wrapper collapse in">
                                                        <div class="panel-body pa-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <c:if test="${item.contractId.status == 'done'}">
                                                                <span style="background-color:  orange" class="label label-success">Chờ Bán</span>
                                                            </c:if>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
