<%-- 
    Document   : category_blog
    Created on : Apr 22, 2019, 6:46:43 PM
    Author     : Cuong
--%>
                                        ...
                                        <div class="col-md-12">
                                            <form action="<%=request.getContextPath()%>/FeatureCreate" class="form form--flex form--property form--basic js-form-property-1">
                                                <div class="form-group">
                                                    <label class="control-label mb-10 text-left" for="example-email">Loại Bài Viết</label>
                                                    <input type="text" name="blogName" class="form-control" placeholder="Loại Bài Viết">
                                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datable_1" class="table table-hover display  pb-30">
                                                ...
                                                <c:forEach items="${featuresList}" var="item">
                                                    ...
                                                    <tr>
                                                        <td>${item.postId}</td>
                                                        <td>${item.postTilte}</td>
                                                        <td>
                                                            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#${item.postId}">
                                                                <span class="glyphicon glyphicon-edit"></span>
                                                            </button>
                                                        </td>
                                                        <td class="datatable__cell-5">
                                                            <a href="<%=request.getContextPath()%>/FeatureDelete?id=${item.postId}" class="btn btn-default">
                                                                <span class="glyphicon glyphicon-trash"></span>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <div id="${item.featuresId}" tabindex="-1" role="dialog" class="modal">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input id="in-1" required type="text" name="featureID" value="${item.postId}" class="form-control" readonly="true">
                                                                                    <label for="in-2" class="control-label">Tiêu đề</label>
                                                                                    <input id="in-2" required type="text" name="featureName" data-placeholder="---" value="${item.postTilte}" class="form-control">
