            ...
            <ul class="navbar__nav">
                    ...
                    <div role="menu" class="js-dropdown-menu navbar__dropdown navbar__dropdown--colls-2">
                        ...
                        <div class="navbar__submenu">
                            ...
                            <ul class="navbar__subnav">
                                ...
                                <li class="navbar__subitem"><a href="<%=request.getContextPath()%>/CustomerEstateCreate" class="navbar__sublink js-navbar-sublink">Estate List Waiting Update</a></li>
                                <li class="navbar__subitem"><a href="<%=request.getContextPath()%>/CustomerDetails" class="navbar__sublink js-navbar-sublink">My Profile</a></li>
                            </ul>
                        </div>
                        <div class="navbar__submenu">
                ...
                <li class="navbar__item js-dropdown"><a class="navbar__link">Pages
                    ...
                    <div role="menu" class="js-dropdown-menu navbar__dropdown navbar__dropdown--colls-1">
                        ...
                        <div class="navbar__submenu">
                            <ul class="navbar__subnav">
                                <li class="navbar__subitem"><a href="page.html" class="navbar__sublink js-navbar-sublink">?ontent page</a></li>
                    ...
                    <div role="menu" class="js-dropdown-menu navbar__dropdown navbar__dropdown--colls-1">
                        ...
                        <div class="navbar__submenu">
                            <ul class="navbar__subnav">
                                ...
                                <li class="navbar__subitem active"><a href="dashboard_property_new.html" class="navbar__sublink">Add Listing</a></li>
