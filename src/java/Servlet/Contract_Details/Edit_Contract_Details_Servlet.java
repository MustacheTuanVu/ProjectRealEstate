 ...
 * @author Cuong
 */
@WebServlet(name = "Edit_Contract_Details_Servlet", urlPatterns = {"/Edit_Contract_Details_Servlet"})
public class Edit_Contract_Details_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("delCon", delCon.findContractDetailsEntities());
        
        request.getRequestDispatcher("WEB-INF/contract_details/edit_contract_details.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Entity.ContractDetails del=conDel.findContractDetails(Integer.valueOf(request.getParameter("txtID")));
            del.setContractId(con);
            del.setEstateId(est);
            del.setId(Integer.valueOf(request.getParameter("txtID")));
            conDel.create(del);
            
            System.out.println("Edit Completed...");
            
        } catch (PreexistingEntityException ex) {
            Logger.getLogger(Edit_Contract_Details_Servlet.class.getName()).log(Level.SEVERE, null, ex);
