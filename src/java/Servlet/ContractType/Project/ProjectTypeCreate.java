 ...
 * @author kiems
 */
@WebServlet(name = "ProjectTypeCreate", urlPatterns = {"/ProjectTypeCreate"})
public class ProjectTypeCreate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/page/dashboard/dashboard_project_create.jsp").forward(request, response);
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ProjectTypeCreate.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(ProjectTypeCreate.class.getName()).log(Level.SEVERE, null, ex);
        }
