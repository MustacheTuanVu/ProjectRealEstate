...
public class ProjectTypeDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/ProjectTypeList");

        } catch (NonexistentEntityException ex) {
            Logger.getLogger(ProjectTypeDelete.class.getName()).log(Level.SEVERE, null, ex);
