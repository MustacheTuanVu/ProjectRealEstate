 ...
 * @author Cuong
 */
@WebServlet(name = "ContractEdit", urlPatterns = {"/ContractEdit"})
public class Edit_Contract_Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("con",conCon.findContract(Integer.valueOf(request.getParameter("id"))) );
        
//        request.getRequestDispatcher("WEB-INF/contract/edit_contract.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Entity.Contract con= conCon.findContract(Integer.valueOf(request.getParameter("txtID")));
            ...
            con.setContractDetails(request.getParameter("txtDetails"));
