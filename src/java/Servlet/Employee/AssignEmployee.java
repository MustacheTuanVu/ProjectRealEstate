 ...
 * @author Cuong
 */
@WebServlet(name = "AssignEmployee", urlPatterns = {"/AssignEmployee"})
public class AssignEmployee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/page/dashboard/employee/dashboard_assign.jsp").forward(request, response);
    }
