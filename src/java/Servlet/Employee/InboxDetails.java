 ...
 * @author kiems
 */
@WebServlet(name = "InboxDetails", urlPatterns = {"/InboxDetails"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null) {
            if (user.getRole().equals("employee")) {
                ...
                Schedule find = scheduleJpaController.findSchedule(Integer.parseInt(request.getParameter("id")));

                request.setAttribute("find", find);

                request.getRequestDispatcher("/admin/page/dashboard/employee/inbox_details.jsp").forward(request, response);
            } else {
