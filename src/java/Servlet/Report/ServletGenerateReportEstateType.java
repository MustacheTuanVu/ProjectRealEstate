 ...
 * @author kiems
 */
@WebServlet(name = "ServletGenerateReportEstateType", urlPatterns = {"/ServletGenerateReportEstateType"})
public class ServletGenerateReportEstateType extends HttpServlet {
