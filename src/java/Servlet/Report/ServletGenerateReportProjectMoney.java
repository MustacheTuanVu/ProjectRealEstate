 ...
 * @author kiems
 */
@WebServlet(name = "ServletGenerateReportProjectMoney", urlPatterns = {"/ServletGenerateReportProjectMoney"})
public class ServletGenerateReportProjectMoney extends HttpServlet {
