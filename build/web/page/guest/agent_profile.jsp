                                                    ...
                                                    <div class="properties properties--grid">
                                                        ...
                                                        <div class="properties__details">
                                                            <div class="properties__info">
                                                                <a href="<%=request.getContextPath()%>/EstateDetails?estateID=${item.id}" class="properties__address">
                                                                    <span class="properties__address-street">${item.estateName}</span>
                                                                    <span class="properties__address-city">${item.address2}</span>
                                                                </a>
