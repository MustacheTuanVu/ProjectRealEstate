...
<%@page import="Controller.ReplyCommentJpaController"%>
...
<html>
    ...
    <body class="blog_details menu-default hover-default ">
            ...
            <nav class="breadcrumbs">
                <div class="container">
                    <ul>
                        ...
                        <li class="breadcrumbs__item"><a href="" class="breadcrumbs__link">Post</a></li>
                    </ul>
                </div>
            </nav>
            <!-- END BREADCRUMBS-->
                                    ...
                                    <div class="widget__content">
                                        <div class="article article--details">
                                            <div class="article__item-header">
                                                <input type="hidden" id="idPost" value="${post.postId}" />
                                            ...
                                            <div class="article__body"><img src="${post.postImage}" alt="Image" height="400" width="800">
                                                ${post.postContent}
                                            </div>
