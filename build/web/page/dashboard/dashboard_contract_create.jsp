...
<html>
    ...
    <body class="dashboard_property_new menu-default hover-default sidebar-left">
        ...
        --><!-- inject:svg -->
    <svg width="0" height="0" style="position:absolute"><symbol viewBox="0 0 264 88" id="default-skin"><g fill="none" fill-rule="evenodd">
        ...
        <path fill="#fff" d="M106 21h5v1h-5z"/><path fill="#fff" d="M109.043 19.008l-.085 5-1-.017.085-5z"/></g>
    </symbol><symbol viewBox="0 0 22 22" id="icon-add--favorites">
                            ...
                            <div class="site__main">
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Add New Contract</h2>
                                        ...
                                        <section class="form-property form-property--dashboard">
                                            ...
                                            <div class="tab-content form-property__content">
                                                <div id="basic" role="tabpanel" class="tab-pane active">
                                                    <form action="<%=request.getContextPath()%>/ContractCreate" method="POST" class="form form--flex form--property form--basic js-form-property-1">
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <h3>Contract Details</h3>
                                                                <label for="in-2" class="control-label">Customer Name</label>
                                                                <select name="cus" id="in-2">
                                                                    <c:forEach items="${listCus}" var="cus" >
                                                                        <option value="${cus.id}"  class="form-control">${cus.customerName}</option> 
                                                                    </c:forEach>
                                                                </select>
                                                                <label for="in-3" class="control-label">Employee Name</label>
                                                                <select name="emp" id="in-3">
                                                                    <c:forEach items="${listEmp}" var="emp" >
                                                                        <option value="${emp.id}"  class="form-control">${emp.employeeName}</option>   
                                                                    </c:forEach>
                                                                </select>
                                                                <label for="in-9" class="control-label">Contract Type</label>
                                                                <select name="type" id="in-9">
                                                                    <c:forEach items="${listType}" var="type" >
                                                                        <option value="${type.id}"  class="form-control">${type.contractTypeName}</option> 
                                                                    </c:forEach>
                                                                </select>
                                                                <label for="in-8" class="control-label">Payment Type</label>
                                                                <select name="pay" id="in-8">
                                                                    <c:forEach items="${listPay}" var="pay" >
                                                                        <option value="${pay.id}"  class="form-control">${pay.paymentFrequencyName}</option> 
                                                                    </c:forEach>
                                                                </select>

                                                                <label for="in-4" class="control-label">Payment Amount</label>
                                                                <input id="in-4"  type="text" name="currency-field" id="currency-field" class="form-control"   data-type="currency">
                                                                <label for="in-1" class="control-label">Percent Commission</label>
                                                                ...
                                                                <input id="in-7" required type="text" name="txtDoc"  class="form-control" >
                                                                <label for="in-10" class="control-label">Details</label>
                                                                <textarea rows="3" cols="2"  id="in-10" required type="text" name="txtDetails"  class="form-control" ></textarea>
                                                        ...
                                                        <div class="row">
                                                            <button class="form__submit" type="submit">Create new </button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        function validation() {
            var per=document.getElementById('in-1').value;
            var details=document.getElementById('in-10').value;
            
            if (per==="") {
                document.getElementById('').innerHTML='Enter Percent Commission';
            }
            if (details==="") {
                document.getElementById('').innerHTML='Enter Details';
            }
