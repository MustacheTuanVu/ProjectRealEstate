                            ...
                            <div class="site__main">
                                ...
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Estate Waiting Manager</h2>
                                    </div>
                                            ...
                                            <div class="datatable datatable--properties">
                                                <div class="datatable__wrap">
                                                    <table class="js-properties-table datatable__table">
                                                        <thead>
                                                            <tr>
                                                                <th class="datatable__head-1"> Project ID</th>
                                                                <th class="datatable__head-2 datatable__head-sort"> Name Project</th>
                                                                <th class="datatable__head-3 datatable__head-sort"> Manager Name</th>


                                                                <th class="datatable__head-6">Edit</th>
                                                                <th class="datatable__head-7">Delete</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <c:forEach items="${listPro}" var="item">
                                                                <tr  data-toggle="modal" data-target="#${item.projectId}">
                                                                    <td class="datatable__cell-1">${item.projectId}</td>
                                                                    <td class="datatable__cell-2">${item.projectName}</td>
                                                                    <td class="datatable__cell-3">${item.managerId.managerName}</td>
                                                                    <td class="datatable__cell-6">
                                                                        <button type="button" class="form__submit" data-toggle="modal" data-target="#${item.projectId}">
                                                                            <span class="glyphicon glyphicon-edit"></span>
                                                                        </button>
                                                                    </td>
                                                                    <td class="datatable__cell-7">
                                                                        <a href="<%=request.getContextPath()%>/PaymentDelete?id=${item.projectId}" class="form__submit">
                                                                            <span class="glyphicon glyphicon-trash"></span>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            <div id="${item.projectId}" tabindex="-1" role="dialog" class="modal fade">
                                                                <div role="document" class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="<%=request.getContextPath()%>/ProjectEdit?id=${item.projectId}" method="POST" class="form form--flex form--property form--basic js-form-property-1">
                                                                                <h3>Details Project</h3>
                                                                                <div class="row">
                                                                                    <div class="form-group form-group--description">
                                                                                        <label for="in-10" class="control-label">Project ID </label>
                                                                                        <input id="in-10" readonly="true" value="${item.projectId}" type="text" name="projectId" data-placeholder="---" class="form-control">
                                                                                    </div>
                                                                                    <div class="form-group form-group--description">
