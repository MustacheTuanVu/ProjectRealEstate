                            ...
                            <div class="site__main">
                                ...
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Transaction Manager</h2>
                                    </div>
                                            ...
                                            <div class="datatable datatable--properties">
                                                <div class="datatable__wrap">
                                                    <table class="js-properties-table datatable__table">
                                                        <thead>
                                                            <tr>
                                                                <th class="datatable__head-1">Number Transaction</th>
                                                                <th class="datatable__head-2 datatable__head-sort">Customer Name</th>
                                                                <th class="datatable__head-3 datatable__head-sort">Number Contract</th>
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${list}" var="item">
                                                                <tr data-toggle="modal" data-target="#${item.id}">
                                                                    ...
                                                                    <td class="datatable__cell-2">${item.customerOffered.customerName}</td>
                                                                    <td class="datatable__cell-3">${item.contractId.id}</td>
                                                                ...
                                                                <div role="document" class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="<%=request.getContextPath()%>/TransactionEdit" method="POST" class="form form--flex form--property form--basic js-form-property-1">
                                                                                <div class="row">
                                                                                    <div class="form-group form-group--description ${hasError}">
                                                                                        ...
                                                                                        <select name="cus" id="in-2">
                                                                                            <c:forEach items="${listCus}" var="cus" >
                                                                                                <option value="${cus.id}" ${cus.id==item.customerOffered.id ? 'selected' : ''} class="form-control">${cus.customerName}</option> 
                                                                                            </c:forEach>
                                                                                        </select>
                                                                                        ...
                                                                                        <select name="con" id="in-8">
                                                                                            <c:forEach items="${listCon}" var="con" >
                                                                                                <option value="${con.id}" ${con.id==item.contractId.id ? 'selected' : ''} class="form-control">${con.id}</option> 
                                                                                            </c:forEach>
                                                                                        </select>
                                                                                        ...
                                                                                        <input id="in-4"  type="text" name="currency-field" id="currency-field" class="form-control" 
                                                                                               pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" value="${item.money}" 
                                                                                               data-type="currency" placeholder="$1,000,000.00">
                                                                                        <label for="in-6" class="control-label">Date Sign</label>
                                                                                        <fmt:formatDate pattern="yyyy-MM-dd" value="${item.transactionsDate}" type="date" var="date" />
                                                                                        ...
                                                                                        <textarea  id="in-10" required type="text" name="txtDetails"  class="form-control" >${item.transactionsNote}</textarea>
