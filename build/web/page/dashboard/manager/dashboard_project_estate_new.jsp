                                                        ...
                                                        <div id="Floor${item}" role="tabpanel" class="tab-pane <c:if test="${item == '1'}">active</c:if>" >
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group form-group ${hasError}">
                                                                    ...
                                                                    <input id="priceB${blocks}F${item}Type1" onchange="priceB${blocks}F${item}Type1()" type="number" name="priceB${blocks}F${item}Type1" data-placeholder="---"  class="form-control">
                                                                    <div class="help-block filled" id="parsley-id-11" style="display: ${hasError}">
                                                                        <div class="parsley-required">${message}</div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group form-group ${hasError}">
                                                                    <label for="in-1" class="control-label">Price Floor ${item}B</label>
                                                                ...
                                                                <div class="form-group form-group ${hasError}">
                                                                    <label for="in-1" class="control-label">Price Floor ${item}C</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group form-group ${hasError}">
                                                                    ...
                                                                    <input id="bedRoomB${blocks}F${item}Type1" required type="number" name="bedRoomB${blocks}F${item}Type1" data-placeholder="---"  class="form-control">
                                                                    <div class="help-block filled" id="parsley-id-11" style="display: ${hasError}">
                                                                        <div class="parsley-required">${message}</div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group form-group ${hasError}">
                                                                    <label for="in-1" class="control-label">Bed Room Floor ${item}B</label>
                                                                ...
                                                                <div class="form-group form-group ${hasError}">
                                                                    <label for="in-1" class="control-label">Bed Room Floor ${item}C</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group form-group ${hasError}">
                                                                    ...
                                                                    <input id="bathRoomB${blocks}F${item}Type1" required type="number" name="bathRoomB${blocks}F${item}Type1" data-placeholder="---"  class="form-control">
                                                                    <div class="help-block filled" id="parsley-id-11" style="display: ${hasError}">
                                                                        <div class="parsley-required">${message}</div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group form-group ${hasError}">
                                                                    <label for="in-1" class="control-label">Bath Room Floor ${item}B</label>
                                                                ...
                                                                <div class="form-group form-group ${hasError}">
                                                                    <label for="in-1" class="control-label">Bath Room Floor ${item}C</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group form-group ${hasError}">
                                                                    ...
                                                                    <input id="areasB${blocks}F${item}Type1" required type="number" name="areasB${blocks}F${item}Type1" data-placeholder="---"  class="form-control">
                                                                    <div class="help-block filled" id="parsley-id-11" style="display: ${hasError}">
                                                                        <div class="parsley-required">${message}</div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group form-group ${hasError}">
                                                                    <label for="in-1" class="control-label">Area Room Floor ${item}B</label>
                                                                ...
                                                                <div class="form-group form-group ${hasError}">
                                                                    <label for="in-1" class="control-label">Area Room Floor ${item}C</label>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <button type="button" class="button__default" data-toggle="modal" data-target="#myModal${item}">Open Modal</button>
                                                            ...
                                                            <div class="row">
                                                                <a href="#Floor${item-1}" aria-controls="Floor${item-1}" class="form__submit" role="tab" data-toggle="tab">Back</a>
                                                                <c:if test="${floorNumber == item}">
                                                                    <button type="submit" name="getEstate" value="getEstate" class="form__submit">SUBMIT</button>
                                                                </c:if>
                                                                <c:if test="${floorNumber != item}">
                                                                    <a href="#Floor${item+1}" aria-controls="Floor${item+1}" class="form__submit" role="tab" data-toggle="tab">Next</a>
                                                                </c:if>
                                                            </div>
