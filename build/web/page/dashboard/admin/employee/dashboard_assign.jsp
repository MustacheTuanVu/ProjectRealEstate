...
<html lang="en">
	<head>
		...
		<!-- Calendar CSS -->
		<link href="<%= request.getContextPath() %>/page/dashboard/admin/vendors/bower_components/fullcalendar/dist/fullcalendar.css" rel="stylesheet" type="text/css"/>
		
		<!-- Custom CSS -->
		<link href="<%= request.getContextPath() %>/page/dashboard/admin/dist/css/style.css" rel="stylesheet" type="text/css">
	</head>
	<body>
		<!--Preloader-->
			...
			<nav class="navbar navbar-inverse navbar-fixed-top">
				<div class="mobile-only-brand pull-left">
					<div class="nav-header pull-left">
						<div class="logo-wrap">
							<a href="index.html">
								<img class="brand-img" src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/logo.png" alt="brand"/>
				...
				<div id="mobile_only_nav" class="mobile-only-nav pull-right">
					<ul class="nav navbar-right top-nav pull-right">
								...
								<li>
									<div class="app-nicescroll-bar">
										<ul class="app-icon-wrap pa-10">
											<li>
												<a href="<%= request.getContextPath() %>/page/dashboard/admin/weather.html" class="connection-item">
												<i class="zmdi zmdi-cloud-outline txt-info"></i>
												<span class="block">weather</span>
												</a>
											</li>
											<li>
												<a href="<%= request.getContextPath() %>/page/dashboard/admin/inbox.html" class="connection-item">
												<i class="zmdi zmdi-email-open txt-success"></i>
												<span class="block">e-mail</span>
												</a>
											</li>
											<li>
												<a href="<%= request.getContextPath() %>/page/dashboard/admin/calendar.html" class="connection-item">
												<i class="zmdi zmdi-calendar-check txt-primary"></i>
												<span class="block">calendar</span>
												</a>
											</li>
											<li>
												<a href="<%= request.getContextPath() %>/page/dashboard/admin/vector-map.html" class="connection-item">
												<i class="zmdi zmdi-map txt-danger"></i>
												<span class="block">map</span>
												</a>
											</li>
											<li>
												<a href="<%= request.getContextPath() %>/page/dashboard/admin/chats.html" class="connection-item">
												<i class="zmdi zmdi-comment-outline txt-warning"></i>
												<span class="block">chat</span>
												</a>
											</li>
											<li>
												<a href="<%= request.getContextPath() %>/page/dashboard/admin/contact-card.html" class="connection-item">
								...
								<li class="product-nicescroll-bar row">
									<ul class="pa-20">
										<li class="col-md-3 col-xs-6 col-menu-list">
											...
											<ul>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/index.html">Analytical</a>
												</li>
												<li>
													<a  href="<%= request.getContextPath() %>/page/dashboard/admin/index2.html">Demographic</a>
												</li>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/index3.html">Project</a>
												</li>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/profile.html">profile</a>
												</li>
											</ul>
											<a href="<%= request.getContextPath() %>/page/dashboard/admin/widgets.html"><div class="pull-left"><i class="zmdi zmdi-flag mr-20"></i><span class="right-nav-text">widgets</span></div><div class="pull-right"><span class="label label-warning">8</span></div><div class="clearfix"></div></a>
											<hr class="light-grey-hr ma-0"/>
											<a href="<%= request.getContextPath() %>/page/dashboard/admin/documentation.html"><div class="pull-left"><i class="zmdi zmdi-book mr-20"></i><span class="right-nav-text">documentation</span></div><div class="clearfix"></div></a>
											<hr class="light-grey-hr ma-0"/>
										</li>
										<li class="col-md-3 col-xs-6 col-menu-list">
											...
											<ul>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/e-commerce.html">Dashboard</a>
												</li>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/product.html">Products</a>
												</li>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/product-detail.html">Product Detail</a>
												</li>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/add-products.html">Add Product</a>
												</li>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/product-orders.html">Orders</a>
												</li>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/product-cart.html">Cart</a>
												</li>
												<li>
													<a href="<%= request.getContextPath() %>/page/dashboard/admin/product-checkout.html">Checkout</a>
												</li>
											</ul>
										</li>
										<li class="col-md-6 col-xs-12 preview-carousel">
											...
											<div class="product-carousel owl-carousel owl-theme text-center">
												<a href="#">
													<img src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/chair.jpg" alt="chair">
													<span>Circle chair</span>
												</a>
												<a href="#">
													<img src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/chair2.jpg" alt="chair">
													<span>square chair</span>
												</a>
												<a href="#">
													<img src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/chair3.jpg" alt="chair">
													<span>semi circle chair</span>
												</a>
												<a href="#">
													<img src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/chair4.jpg" alt="chair">
								...
								<li>
									<div class="streamline message-nicescroll-bar">
										...
										<div class="sl-item">
											<a href="javascript:void(0)">
												<div class="sl-avatar">
													<img class="img-responsive" src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/avatar.jpg" alt="avatar"/>
												</div>
												<div class="sl-content">
						...
						<li class="dropdown auth-drp">
							<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user1.png" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
							<ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
								<li>
									<a href="<%= request.getContextPath() %>/page/dashboard/admin/profile.html"><i class="zmdi zmdi-account"></i><span>Profile</span></a>
								</li>
								<li>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						...
						<ul id="app_dr" class="collapse collapse-level-1">
							...
							<li>
								<a class="active-page" href="calendar.html">calendar</a>
							</li>
							<li>
													...
													<ul class="chat-list-wrap">
														<li class="chat-list">
															<div class="chat-body">
																<a  href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user.png" alt="user"/>
																		<div class="user-data">
																...
																<a  href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user1.png" alt="user"/>
																		<div class="user-data">
																...
																<a  href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user2.png" alt="user"/>
																		<div class="user-data">
																...
																<a  href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user3.png" alt="user"/>
																		<div class="user-data">
																...
																<a  href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user4.png" alt="user"/>
																		<div class="user-data">
															...
															<ul class="nicescroll-bar pt-20">
																<li class="friend">
																	<div class="friend-msg-wrap">
																		<img class="user-img img-circle block pull-left"  src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user.png" alt="user"/>
										...
										<div class="set-height-wrap">
											<div class="streamline message-box nicescroll-bar">
												<a href="javascript:void(0)">
													<div class="sl-item unread-message">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user.png" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<a href="javascript:void(0)">
													<div class="sl-item">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user1.png" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<a href="javascript:void(0)">
													<div class="sl-item">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user2.png" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<a href="javascript:void(0)">
													<div class="sl-item unread-message">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user3.png" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<a href="javascript:void(0)">
													<div class="sl-item unread-message">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="<%= request.getContextPath() %>/page/dashboard/admin/dist/img/user4.png" alt="avatar"/>
														</div>
														<div class="sl-content">
		...
		<!-- jQuery -->
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/vendors/bower_components/jquery/dist/jquery.min.js"></script>
		
		<!-- Bootstrap Core JavaScript -->
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/vendors/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
		
		<!-- Calender JavaScripts -->
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/vendors/bower_components/moment/min/moment.min.js"></script>
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/vendors/jquery-ui.min.js"></script>
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/vendors/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/dist/js/fullcalendar-data.js"></script>
		
		<!-- Slimscroll JavaScript -->
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/dist/js/jquery.slimscroll.js"></script>
		
		<!-- Owl JavaScript -->
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/vendors/bower_components/owl.carousel/dist/owl.carousel.min.js"></script>
		
		<!-- Switchery JavaScript -->
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/vendors/bower_components/switchery/dist/switchery.min.js"></script>
		
		<!-- Fancy Dropdown JS -->
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/dist/js/dropdown-bootstrap-extended.js"></script>
		<!-- Init JavaScript -->
		<script src="<%= request.getContextPath() %>/page/dashboard/admin/dist/js/init.js"></script>
