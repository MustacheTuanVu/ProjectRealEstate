                    ...
                    <div class="row">
                        ...
                        <div class="site site--dashboard">
                            <div class="site__main">
                                        ...
                                        <section class="form-property form-property--dashboard">
                                            ...
                                            <div class="tab-content form-property__content">
                                                <div id="basic" role="tabpanel" class="tab-pane active">
                                                    <form action="<%=request.getContextPath()%>/PaymentCreate" method="POST" class="form form--flex form--property form--basic js-form-property-1">
                                                        <div class="row">
                                                            <div class="form-group form-group--description ${hasError}">
                                                                <label for="in-1" class="control-label">Payment Name</label>
                                                                <input id="in-1" required type="text" name="txtPay" data-placeholder="Input Type Name" value="" class="form-control">
                                ...
                                <div class="widget js-widget widget--dashboard">
                                    <div class="widget__header">
                                        <h2 class="widget__title">Payment manager</h2>
                                    </div>
                                    <div class="widget__content">
                                        <!-- BEGIN Favorites-->
                                        <section class="form-property form-property--dashboard">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="<%=request.getContextPath()%>/PaymentEdit" method="POST" class="form form--flex form--property form--basic js-form-property-1">
                                                                                <div class="row">
                                                                                    <div class="form-group form-group--description ${hasError}">
                                                                                        <label for="in-1" class="control-label">Payment ID</label>
                                                                                        <input id="in-1" required type="text" name="txtID" value="${item.id}" class="form-control" readonly="true">
                                                                                        <label for="in-2" class="control-label">Payment Name</label>
